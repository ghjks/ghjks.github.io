(() => {
    ...
    const script_link = document.querySelector(".catalog__link");
    const linkBack = document.querySelector(".catalog__link-back");
    const secondContent = document.querySelector(".catalog__second-content");
    script_link.addEventListener("click", (() => {
        secondContent.classList.add("_active");
    }));
    linkBack.addEventListener("click", (() => {
        secondContent.classList.remove("_active");
    }));
    window["FLS"] = true;
    isWebp();
    tabs();
